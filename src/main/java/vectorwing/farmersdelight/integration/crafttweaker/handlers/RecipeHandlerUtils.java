...
public class RecipeHandlerUtils {
    public static final IRecipeComponent<SoundEvent> SOUND_COMPONENT = IRecipeComponent.simple(
            new ResourceLocation(FarmersDelight.MODID, "recipe_component/sound"), new TypeToken<>(){}, (soundEvent, soundEvent2) -> soundEvent.getLocation().equals(soundEvent2.getLocation()));
